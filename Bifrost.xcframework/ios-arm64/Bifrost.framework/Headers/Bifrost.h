...
- (void)getTrainingsType:(BifrostTrainingsTimeType *)type completion:(void (^)(BifrostResponseType *, NSMutableArray<BifrostTrainingModel *> *))completion __attribute__((swift_name("getTrainings(type:completion:)")));
@end;
