...
- (void)executeQueryQuery:(id<BifrostApollo_apiQuery>)query completion:(void (^)(BifrostApollo_apiApolloResponse<id<BifrostApollo_apiQueryData>> *))completion __attribute__((swift_name("executeQuery(query:completion:)")));
@end;
