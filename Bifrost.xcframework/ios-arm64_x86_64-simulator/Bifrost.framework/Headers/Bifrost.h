...
@interface BifrostCommonFlow<T> : BifrostBase <BifrostKotlinx_coroutines_coreFlow>
...
@interface BifrostAppConstant : BifrostBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface BifrostDateUtil : BifrostBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)dateUtil __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) BifrostDateUtil *shared __attribute__((swift_name("shared")));
