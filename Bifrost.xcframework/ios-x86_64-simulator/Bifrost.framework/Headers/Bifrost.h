...
- (void)getTrainingListType:(BifrostTrainingsTimeType *)type completion:(void (^)(BifrostResponseType *, NSMutableArray<BifrostTrainingModel *> *))completion __attribute__((swift_name("getTrainingList(type:completion:)")));
@end;
